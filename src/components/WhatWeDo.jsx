...
const services = [
  {
    ...
    title: "Home",
    description:
      "Complete glass interior solutions, sliding doors, and mirrors for residential spaces.",
  ...
  },
  {
    ...
    title: "Office",
    description:
      "Custom glass workstations, cabins, doors, and functional spaces for modern offices.",
  ...
  },
  {
    ...
    title: "Fasad Work",
    description:
      "Structural and semi-structural facade work, curtain walls, and spider glass for building exteriors.",
  ...
  },
  {
    ...
    title: "IT Park",
    description:
      "Large scale exterior glazing, energy-efficient glass installations, and massive window systems for IT parks.",
    ...
    const unsubServices = onSnapshot(
      ...
      (querySnapshot) => {
        if (!querySnapshot.empty) {
          ...
          const finalServices =
            featuredList.length > 0 ? featuredList : list.slice(0, 6);
        ...
        <div className="max-w-6xl mx-auto px-6 animate-pulse">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 h-80 flex flex-col"
              >
