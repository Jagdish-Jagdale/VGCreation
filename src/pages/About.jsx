            ...
            <div className="bg-white border border-slate-100 rounded-3xl p-6 md:p-8 w-full shadow-sm min-h-[220px]">
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-y-4.5 gap-x-8">
                {pointsList[activeTab]?.subpoints?.map((item, idx) => (
                  ...
                  >
                    <svg
                      className="w-4.5 h-4.5 text-sky-400 shrink-0"
                      fill="none"
                      stroke="currentColor"
                      strokeWidth="3.5"
                      viewBox="0 0 24 24"
      ...
      {partnersList.length > 0 && (
        <section className="relative py-20 bg-gradient-to-r from-[#0ea5e9] via-[#0284c7] to-[#031525] text-white overflow-hidden text-center border-t border-slate-900">
          ...
          <div
            ...
            style={{
              backgroundImage:
                "linear-gradient(to right, #1481b8 1px, transparent 1px), linear-gradient(to bottom, #1481b8 1px, transparent 1px)",
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-6">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 max-w-5xl mx-auto">
              {partnersList.map((partner, idx) => (
                <div
                  key={idx}
                  className="flex items-center gap-3 bg-white/5 backdrop-blur-md border border-white/10 hover:border-sky-400/40 hover:bg-white/10 px-6 py-3.5 rounded-2xl transition-all duration-300 hover:-translate-y-0.5 group"
                >
                  <svg
                    className="w-5 h-5 text-sky-400 shrink-0 group-hover:scale-105 transition-transform"
                    fill="none"
                    stroke="currentColor"
                    strokeWidth="2.5"
                    viewBox="0 0 24 24"
