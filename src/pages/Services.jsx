        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {isFetching ? (
            ...
            servicesList.slice(0, visibleCount).map((service, index) => (
              <div
                key={service.id}
                className={`bg-white rounded-2xl border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 flex flex-col h-full group ${index >= 8 ? "animate-fade-in-up" : ""
                  }`}
